...
{
  this->SendCommand(lidar_slam::msg::SlamCommand::SAVE_TRAJECTORY, this->TrajectoryPath);
}
...
{
  this->SendCommand(lidar_slam::msg::SlamCommand::SAVE_FILTERED_KEYPOINTS_MAPS, this->MapsPath);
}
...
{
  this->SendCommand(lidar_slam::msg::SlamCommand::CALIBRATE_WITH_POSES, this->PosesPath);
}
